...
# in_dir = "/Users/Tristan/Downloads/xxx/survival"
in_dir = '/exports/neur-vanos/data/preprocessed/Preprocessed17clas.csv'
# fill in the directory where you want the output to be saved
out_dir = '' #some dir

# Put the algorithms that you want to train in the following 
